...
Beachbox is a really simple configurator for hassle-free self-hosting (containerized) of a web app or API on a virtual private server (VPS) or bare-metal server of any size at a fraction of the cost compared to cloud platforms, with blazing fast performance, full control, and no vendor lock-in.
